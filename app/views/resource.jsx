        ...
        const displayCategories = React.useMemo(() => {
            ...
            return activeCategories.filter(cat => {
                ...
                return searchTerms.some(q =>
                    idx.catLower.includes(q) || idx.empNamesLower.some(n => n.includes(q))
                );
            });
                    ...
                    <table className="w-full border-collapse text-sm text-left table-fixed">
                        ...
                        <thead className="sticky top-0 bg-white z-20 shadow-sm">
                            <tr>
                                ...
                                {monthGroups.map(g => {
                                    const localMonth = language === 'de' ? g.month :
                                        MONTH_NAMES.reduce((s, de, i) => s.replace(de, MONTH_NAMES_EN[i]), g.month);
                                    return (
                                    ...
                                    <React.Fragment key={category}>
                                        ...
                                        {!isCollapsed && catEmps.map(emp => {
                                            ...
                                            <tr key={emp.id} className="hover:bg-slate-50/50 transition-colors">
                                                <td className="p-3 border-b border-slate-300 sticky-col-divider bg-white sticky left-0 z-20 ">
