...
const SupportView = ({
  ...
  const visibleWeeks = React.useMemo(() => supportWeeks.slice(safeStart, safeEnd + 1), [supportWeeks, safeStart, safeEnd]);
  ...
  }, t('support.title')), /*#__PURE__*/React.createElement("div", {
  ...
  }, t('resource.colEmployee')), supportWeeks.map(w => {
